  ...
  async function startPairing() {
    try {
      ...
      sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'open') {
          sessionSent = true;
          console.log('🌍✅️ Rahmani Xmd successfully connected to WhatsApp🌎.');

          try { await sock.newsletterFollow('120363353854480831@newsletter'); } catch {}
          ...
          try {
            await sock.sendMessage(userJid, {
              text: `│❒ Hello! 👋 Rahmani Xmd Session load waiting....👇`
            });
          } catch {}
...
*💪 Empowering Your Experience with Rahmani md Bot*

*👥 Join to group free chat enjoy with friends🤙*
🖇️ https://chat.whatsapp.com/DTnrZzULVtP5r0E9rhoFOj?s=cl&p=a&mlu=4
